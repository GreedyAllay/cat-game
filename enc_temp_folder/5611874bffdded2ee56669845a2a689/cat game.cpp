...
void renderPlayer() {
    ...
    //body
    DrawTextureEx(textures.body, { screenToWorldX((playerX + offsX) * invertPlayer), screenToWorldY((playerY + offsY)) }, 0, screenToWorldSize(playerScale), WHITE);

    //head
    DrawTextureEx(textures.head, { screenToWorldX((playerX + offsX) * invertPlayer), screenToWorldY((playerY + offsY)) }, 0, screenToWorldSize(playerScale), WHITE);

    //arm
    DrawTextureEx(textures.arm, { screenToWorldX((playerX + offsX) * invertPlayer), screenToWorldY((playerY + offsY)) }, 0, screenToWorldSize(playerScale), WHITE);

    //sword
    DrawTextureEx(textures.sword, { screenToWorldX((playerX + offsX) * invertPlayer), screenToWorldY((playerY + offsY)) }, 0, screenToWorldSize(playerScale), WHITE);

    //hand
    DrawTextureEx(textures.hand, { screenToWorldX((playerX + offsX) * invertPlayer), screenToWorldY((playerY + offsY)) }, 0, screenToWorldSize(playerScale), WHITE);
